package com.cymon.cog.configuration;


import com.cymon.cog.jwt.JwtAccessDeniedHandler;
import com.cymon.cog.jwt.JwtAuthenticationEntryPoint;
import com.cymon.cog.jwt.TokenProvider;
...
//    }
   ...
   // protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .exceptionHandling()
                .authenticationEntryPoint(jwtAuthenticationEntryPoint) // 인증실패 처리
                ...
                .antMatchers("/api/v1/mypage/**").hasAnyAuthority("USER") // 마이페이지 유저만
