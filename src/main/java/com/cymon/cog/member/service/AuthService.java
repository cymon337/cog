...
import com.cymon.cog.exception.DuplicatedUsernameException;
...
import com.cymon.cog.member.dto.TokenDto;
...
public class AuthService {
    ...
    public MemberDto signup(MemberDto memberDto) {
        ...
        if(memberMapper.selectByMobile(memberDto.getMemberMobile()) != null) {
            log.info("[AuthService] 휴대폰번호가 중복됩니다.");
            throw new DuplicatedUsernameException("휴대폰번호가 중복됩니다.");
        }
